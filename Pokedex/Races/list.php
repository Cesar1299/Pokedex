...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <div class="card-header text-white bg-dark " >
            <h2>No hay tipos de pokemon registrado, <a href="add.php" class="btn btn-primary my-2"><i class="fa fa-plus-square"></i> Agregar nuevo tipo de pokemon</a> </h2>
            ...
            <div style="margin-top: 3%;" class="row">
                ...
                <div class="col-md-12">
                    <div class="row" style="margin-bottom: 2%;">
                        <a href="add.php" class="btn bg-success text-white">Tipo de Pokemon</a>
                    </div>
