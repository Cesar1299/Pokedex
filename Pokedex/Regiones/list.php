...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <?php if (empty($listadoRegion)) : ?>

        <div style="margin-top: 10%;margin-bottom: 7%; " class="card">
        <div class="card-header text-white bg-dark " >
            <h2>No hay Region de pokemon registrado, <a href="add.php" class="btn btn-primary my-2"><i class="fa fa-plus-square"></i> Agregar nueva Region de pokemon</a> </h2>
            ...
            <div style="margin-top: 3%;" class="row">
                ...
                <div class="col-md-12">
                    <div class="row" style="margin-bottom: 2%;">
                        <a href="add.php" class="btn bg-success text-white">Region de Pokemon</a>
                    </div>
