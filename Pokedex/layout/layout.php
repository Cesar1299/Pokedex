...
function printHeader(){
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <a class="navbar-brand" href="{$this->directory}index.php">Pokedex</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="{$this->directory}Pokemon/add.php">Pokemones <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{$this->directory}Races/list.php">Tipos</a>
          </li>   
          <li class="nav-item">
          <a class="nav-link" href="{$this->directory}Regiones/list.php">Regiones</a>
        </li>   
        </ul>   
      </div>
    </nav>
